...
\input{winkelhistogramme}

\input{korrelationDerWinkelhistogramme}

\input{rotationskorrektur}

\input{hauptachsenalignenDerKarte}

\input{xyHistogramme}

\input{korrelationDerXYHistogramme}

\input{translationskorrektur}

\input{verrauschteDaten}

\input{parameteroptimierung}

\input{regelmaessigesAchsenalignen}
